...
def InstallProxyCert(my_manager,pruned_GN_Nodes,pKey,irods_proxycert_file,USERURN,SLICEURN,slice_uuid,q):
...
def main(argv=None):
	...
	for my_manager in managers:	
		...
		p = multiprocessing.Process(target=InstallProxyCert,args=(my_manager,pruned_GN_Nodes,pKey,irods_proxycert_file,USERURN,gemini_util.SLICEURN,slice_uuid,my_queue,))
		proclist.append(p)
